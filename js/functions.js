...
(function () {
    ...
    let helloMessage = sayHello("Crystal")
...
// and stores it in a variable named random
    ...
    alert("You add $" + calculateTip(userTip, userTotal) + " to your bill.");
    ...
    function applyDiscount(itemPrice, discountPercentage) {
        let discountPercent = itemPrice - (discountPercentage * itemPrice);
        return itemPrice;
    }
